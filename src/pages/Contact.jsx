                                ...
                                {!reason ?
                                    <div className="presentation align-items-top">
                                        ...
                                        <div className="cta-section mb-3">
                                            {/*<button className="btn btn-black mb-2" onClick={() => setReason("scolar")} disabled={new Date().getTime() < new Date("2024-08-15T00:00:00Z").getTime()}>Accompagnement scolaire</button>*/}
                                            ...
                                            <button className="btn btn-black" onClick={() => setReason("other")}>Autre</button>
                                        </div>
