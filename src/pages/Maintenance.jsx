    ...
    return (
        <div className="maintenance-page">
            ...
            <main className="maintenance-shell" ref={containerRef}>
                <span className="maintenance-kicker">Mise à jour système</span>
                <h1>Maintenance en cours</h1>
                <p>
                    Le serveur subit actuellement quelques transformations géométriques. Je remets de l'ordre dans les fonctions pour vous proposer une expérience optimale très vite.
                </p>
